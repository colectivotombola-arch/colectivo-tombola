    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-primary/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href={`https://wa.me/${settings?.whatsapp_number || '0999053073'}`}
            target="_blank"
      ...
      <footer className="bg-black text-white py-12">
        <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {socialMedia.facebook_url && (
                  <a href={socialMedia.facebook_url} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                ...
                {socialMedia.instagram_url && (
                  <a href={socialMedia.instagram_url} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {socialMedia.twitter_url && (
                  <a href={socialMedia.twitter_url} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {socialMedia.tiktok_url && (
                  <a href={socialMedia.tiktok_url} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 {settings?.site_name || 'Colectivo Tombola'}. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
