      ...
      <section className="mobile-section bg-primary/10">
        <div className="mobile-container text-center">
          ...
          <a
            ...
            className="inline-flex items-center px-4 py-3 sm:px-6 sm:py-4 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors mobile-text"
          >
