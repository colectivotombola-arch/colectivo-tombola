-- First add the missing price_per_number column to site_settings
ALTER TABLE public.site_settings 
ADD COLUMN IF NOT EXISTS price_per_number TEXT DEFAULT '1.50';
...
-- Fix the prizes table missing is_active column
